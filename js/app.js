...
function initMap() {
    ...
    //trigger update on search box when selected a place in google list
    searchBox.addListener('places_changed', function() {
        ko.utils.triggerEvent(searchText, "change");
    });
...
function AppViewModel() {
    ...
    self.filterPlaces = function() {
        ...
        self.filterValue = self.filterValue.toLowerCase();
        //loop of markers to filter array 
        self.restaurants().forEach(function(place) {
            if (place.name.toLowerCase().search(self.filterValue) != -1) {
